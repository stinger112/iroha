...
namespace iroha {
  ...
  void sha3_256(unsigned char *output, const unsigned char *input, size_t in_size);
  void sha3_512(unsigned char *output, const unsigned char *input, size_t in_size);
